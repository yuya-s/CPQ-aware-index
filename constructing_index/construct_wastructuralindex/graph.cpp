...
//            vertex_edge_list[stoi(v1)].push_back(edge_list.size()-1);
            ...
            if(countVertexNum>number_of_vertices || countLabelNum>number_of_labels||edge_list.size()>number_of_edges){
        ...
        //cout<<countVertexNum<<","<<number_of_vertices<<","<<countLabelNum<<","<<number_of_labels<<","<<edge_list.size()<<","<<number_of_edges<<endl;
